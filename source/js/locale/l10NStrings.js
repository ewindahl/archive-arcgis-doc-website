var localeJsonObj = {
   ...
   "da": {
      ...
      "ops-dashboard": "Ops-instrumentbræt", 
   ...
   "it": {
      ...
      "native-language": "italiano e inglese", 
   ...
   "ja": {
      ...
      "esri-maps-office": "Maps for Office", 
      "features": "フィーチャ", 
      "feedback": "このトピックに関してフィードバックはありますか？", 
      "feedback-confirmation-note": "このサイトへのご意見をお寄せいただき、ありがとうございます。Esri では、お客様のフィードバックを重要視し、サイトを改善できるよう努めています。  ", 
      "feedback-on-this-page": "このページに関してフィードバックはありますか？", 
      "feedback-on-this-topic": "このトピックに関してフィードバックはありますか？", 
   ...
   "zh-cn": {
      "404-note": "无法找到您所寻找的页面。请检查您输入的 URL 并重试。如果是通过外部链接转到此处，请联系我们以便我们修复该问题。 ", 
      "about-esri": "关于 Esri ", 
      "about-us": "关于我们 ", 
      ...
      "nav_arcgis_mkt": "获取组织的应用程序和数据", 
      "nav_arcgis_org": "了解有关 ArcGIS for Organizations 的详细信息", 
      "nav_arcgis_platform": "Arc<span>GIS</span> Platform", 
      "nav_arcgis_pro": "在桌面和服务器上构建 GIS Foundation", 
