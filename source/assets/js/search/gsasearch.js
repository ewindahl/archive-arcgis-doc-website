...
//tchen: correct?
app.tmplt.filter = _.template('<div class="accordion-section is-active" area-expanded="true"><header><h4 class="accordion-title filter-header"><%= header %></a></header></h4>' +
...
app.SearchLangView = Backbone.View.extend({
  ...
  choose : function (e) {
    ...
    this.model.set ({"language":lang, "p":0}, {silent:true});
