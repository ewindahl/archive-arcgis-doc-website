...
doc.l10n = (function () {
    ...
    var langList = {
      ...
      lgPartial = ["cs", "da", "et", "fi", "he", "it","ko", "lt", "lv", "nl","no","pl","pt-br","pt-pt","ro","sv", "th", "tr"],
...
doc.supportForm = (function() {
            ...
            $.ajax({
               ...
               cache: false,
                    data: {
                        ...
                        userFeedback:encodeURIComponent($('#userFeedback').val()), 
	...
	/*************** End of Captcha code *************/
		...
		addReferrerLink : function (curlang) {
			var referPageLink = "",
                referrer = $('#regarding').val();


			$('#referPageLink').val("Return to the " + "<a href=''>referring page</a>");			
			if(referrer != ""){
				if((localeJsonObj[curlang]['return-to-referring-page'])){
                    document.getElementById("referPageLink").innerHTML = localeJsonObj[curlang]['return-to-referring-page'];
					$("#feedback-referring-link").attr("href",referrer);
				}
			}
		}
	};
